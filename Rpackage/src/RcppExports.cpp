...
RcppExport SEXP _SCINET_constructNet(SEXP ASEXP, SEXP netSEXP, SEXP samplesSEXP, SEXP rand_sample_noSEXP, SEXP rand_sample_sizeSEXP, SEXP thread_noSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _SCINET_constructDiffNet(SEXP mu1SEXP, SEXP sigma1_sqSEXP, SEXP n1SEXP, SEXP mu2SEXP, SEXP sigma2_sqSEXP, SEXP n2SEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_SCINET_constructNet", (DL_FUNC) &_SCINET_constructNet, 6},
    {"_SCINET_constructDiffNet", (DL_FUNC) &_SCINET_constructDiffNet, 6},
    {NULL, NULL, 0}
};
